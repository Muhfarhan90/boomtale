                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('price') is-invalid @enderror"
                                            id="price" name="price" value="{{ old('price') }}" placeholder="100000"
                                            required min="0">
                                        @error('price')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="discount_price" class="form-label">
                                        ...
                                        Harga Diskon <span class="text-danger">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number"
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Ukuran maksimal: 5MB. Format: JPG, PNG, GIF</div>
                            ...
                            <div>
                                ...
                                <div class="form-text">Ukuran maksimal: 20MB total. Format: JPG, PNG, GIF</div>
